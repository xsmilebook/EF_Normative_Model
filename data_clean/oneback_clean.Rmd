...
write(sprintf("%-50s | Removed: %4d | Remaining: %4d\n", "Removed Oneback_acc outliers (>3 SD from mean)", removed_outlier_count, nrow(data_after_outliers)), file = report_path, append = TRUE)
