...
# Identify outliers based on Twoback_acc (> 3 SD from age group mean)
...
cat(sprintf("%-50s | Removed: %4d | Remaining: %4d\n", "Removed Twoback_acc outliers (>3 SD from mean)", removed_outlier_count, nrow(data_after_outliers)))
