...
write.csv(derivative_summary, file = file.path(output_dir, "1backAcc", "derivative_summary_1backAcc.csv"), row.names = FALSE)
ggsave(file.path(figure_dir, "mu_derivative_age_1backAcc.png"), plot = p1, width = 8, height = 6, dpi = 300)
ggsave(file.path(figure_dir, "sigma_derivative_age_1backAcc.png"), plot = p2, width = 8, height = 6, dpi = 300)