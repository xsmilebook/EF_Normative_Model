...
ggsave(paste0(FigureFolder, "/GNGd/distribution_BIC_GNGd_prime.pdf"), width=9, height=7, units = "cm")
ggsave(paste0(FigureFolder, "/GNGd/distribution_BIC_GNGd_prime.tiff"), width=9, height=7, units = "cm")
...
# Save the plot
ggsave(paste0(FigureFolder, "/GNGd/bsdf_BIC_GNGd_prime.tiff"), width = 9, height = 7, units = "cm")
ggsave(paste0(FigureFolder, "/GNGd/bsdf_BIC_GNGd_prime.pdf"), width = 9, height = 7, units = "cm")
...
# residual plots & Q-Q plots
tiff(paste0(FigureFolder, "/GNGd/diagnosis_mod_", str_split_i(as.character(model.GNGd_prime$mu.formula), "~", 1)[2], ".tiff"),res=600, width=4000, height=3000)
newpar <- par(mfrow = c(2, 2), mar = par("mar") + c(0, 1, 0,0),
...
dev.off()
# Detrended transformed Owen’s plots
tiff(paste0(FigureFolder, "/GNGd/diagnosis_owenplot_mod_", str_split_i(as.character(model.GNGd_prime$mu.formula), "~", 1)[2], ".tiff"),res=600, width=4000, height=3000)
dtop(model.GNGd_prime)
dev.off()
...
ggsave(paste0(FigureFolder, "/GNGd/bootstrap_P50_95CI_GNGd_prime_all.tiff"), width=9, height=7, units = "cm")
ggsave(paste0(FigureFolder, "/GNGd/bootstrap_P50_95CI_GNGd_prime_all.pdf"), width=9, height=7, units = "cm")
