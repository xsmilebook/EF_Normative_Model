...
if (str_detect(wd, "cuizaixu_lab")){
  ...
  FigureFolder <- '/Users/tanlirou/Documents/YF_EF_psy/EF_psy/correlation/resutls_Age'
  interfileFolder <- "/Users/tanlirou/Documents/YF_EF_psy/EF_psy/correlation/resutls_Age"
  functionFolder <- "/Users/tanlirou/Documents/YF_EF_psy/EF_psy/correlation/functions"
  resultFolder <- "/Users/tanlirou/Documents/YF_EF_psy/EF_psy/correlation/resutls_Age"
}

# source functions
#source(paste0(functionFolder, "/gam_varyingcoefficients.R"))
source(paste0(functionFolder, "/gamcog_withsmoothvar.R"))
...
Fcorr.result.period.df <- rbind(corr.result.period.df.con)
## plot
...
## Data preparation
y_levels <- c("SDQ_ES_sum", "SDQ_PP_sum", "SDQ_CP_sum", "SDQ_H_sum", "SDQ_PB_sum")
combined_results$correstimate <- as.numeric(combined_results$correstimate)

# Custom labels for psychiatric variables
psy_labels <- c("SDQ_ES_sum" = "Emotional Problems",
                "SDQ_PP_sum" = "Peer Problems", 
                "SDQ_CP_sum" = "Conduct Problems",
                "SDQ_H_sum" = "Hyperactivity", 
                "SDQ_PB_sum" = "Prosocial Behavior")
