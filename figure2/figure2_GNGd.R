...
if (str_detect(wd, "cuizaixu_lab")){
  ...
  # create subfolder
  resultFolder <- "/ibmgpfs/cuizaixu_lab/xuhaoshu/EF_Normative_Model/anova/results/individual_results"
  FigureFolder <- "/ibmgpfs/cuizaixu_lab/xuhaoshu/EF_Normative_Model/anova/figures/individual_figures"
} else {
