...
#SBATCH --job-name=GNGd_array_analysis 
#SBATCH --output=/ibmgpfs/cuizaixu_lab/xuhaoshu/datasets/yunfu/logs/fig2/GNGd_analysis_%A_%a.out 
#SBATCH --error=/ibmgpfs/cuizaixu_lab/xuhaoshu/datasets/yunfu/logs/fig2/GNGd_analysis_%A_%a.err  
